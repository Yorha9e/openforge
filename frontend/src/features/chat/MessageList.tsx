    ...
    <div ref={listRef} style={{ flex: 1, overflowY: 'auto', padding: '16px 24px', fontFamily: tokens.fontBody }} aria-live="polite" role="log" aria-label="Chat messages">
      ...
      {streaming && (
        <div style={{ display: 'flex', justifyContent: 'flex-start', marginBottom: 12 }}>
          <div style={{ maxWidth: '80%', borderRadius: 8, padding: '10px 16px', background: tokens.surface, color: tokens.text, fontSize: 14, lineHeight: 1.6 }}>
            <div
              className="markdown-body"
      ...
      <style>{`
        ...
        .markdown-body pre { background: ${tokens.bg}; padding: 12px; border-radius: 6px; overflow-x: auto; margin: 8px 0; }
        .markdown-body pre code { background: none; padding: 0; }
        .markdown-body ul, .markdown-body ol { padding-left: 20px; margin: 4px 0; }
        .markdown-body blockquote { border-left: 3px solid ${tokens.cta}; padding-left: 12px; margin: 8px 0; color: ${tokens.muted}; }
        ...
        .markdown-body a { color: ${tokens.cta}; }
        .markdown-body table { border-collapse: collapse; width: 100%; margin: 8px 0; }
        .markdown-body th, .markdown-body td { border: 1px solid ${tokens.border}; padding: 6px 10px; text-align: left; font-size: 13px; }
